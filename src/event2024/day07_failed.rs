//! attempted to do this via looping. Initially started with the correct ruleset
//! but didn't see that could be done recursingly
//! when viewing the answers -- i need to recognize when recursion / dynamic programming
//! can work for `permutation` style problems. keep on learning!
